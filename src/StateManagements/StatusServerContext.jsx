...
export const StatusServerContext = createContext();

export const StatusServerProvider = (props) => {
  //Global State
  ...
  const [inputStatusServer, setInputStatusServer] = useState({
    username: "",
    full_name: "",
    password: "",
    confirm_password: "",
  ...
  const handleCreateDataStatusServer = (events) => {
  ...
  const handleInputStatusServer = (events) => {
    let value = events.target.value;
    let name = events.target.name;
    // console.log(`${name}, ${score}, ${course}, ${value}`)

    if (name === "username") {
      setInputStatusServer({ ...inputStatusServer, username: value });
    } else if (name === "full_name") {
      setInputStatusServer({ ...inputStatusServer, full_name: value });
    } else if (name === "password") {
      setInputStatusServer({ ...inputStatusServer, password: value });
    } else if (name === "confirm_password") {
      setInputStatusServer({ ...inputStatusServer, confirm_password: value });
    } else if (name === "role") {
      setInputStatusServer({ ...inputStatusServer, role: value });
    }
    // else if (name === "sip_number") {
    //   setInputStatusServer({ ...inputStatusServer, sip_number: value });
    // }
  };
  ...
  let handleFunctionStatusServer = {
    handlePageChange,
    handleLimitChange,
    handleCreateDataStatusServer,
    fetchUsers,
    handleInputStatusServer,
    handleApproveUser,
