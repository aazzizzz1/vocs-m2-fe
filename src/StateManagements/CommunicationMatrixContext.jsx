...
export const CommunicationMatrixContext = createContext();

export const CommunicationMatrixProvider = (props) => {
  //Global State
  ...
  const [inputCommunicationMatrix, setInputCommunicationMatrix] = useState({
    username: "",
    full_name: "",
    password: "",
    confirm_password: "",
  ...
  const handleCreateDataCommunicationMatrix = (events) => {
  ...
  const handleInputCommunicationMatrix = (events) => {
    let value = events.target.value;
    let name = events.target.name;
    // console.log(`${name}, ${score}, ${course}, ${value}`)

    if (name === "username") {
      setInputCommunicationMatrix({ ...inputCommunicationMatrix, username: value });
    } else if (name === "full_name") {
      setInputCommunicationMatrix({ ...inputCommunicationMatrix, full_name: value });
    } else if (name === "password") {
      setInputCommunicationMatrix({ ...inputCommunicationMatrix, password: value });
    } else if (name === "confirm_password") {
      setInputCommunicationMatrix({ ...inputCommunicationMatrix, confirm_password: value });
    } else if (name === "role") {
      setInputCommunicationMatrix({ ...inputCommunicationMatrix, role: value });
    }
    // else if (name === "sip_number") {
    //   setInputCommunicationMatrix({ ...inputCommunicationMatrix, sip_number: value });
    // }
  };
  ...
  let handleFunctionCommunicationMatrix = {
    handlePageChange,
    handleLimitChange,
  ...
  return (
    ...
    <CommunicationMatrixContext.Provider
      value={{
